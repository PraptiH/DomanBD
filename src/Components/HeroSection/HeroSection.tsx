...
function HeroSection() {
    return (
        <>
            <div className=" bg-[#e7f1f1] mx-5 lg:mx-15 md:mx-15 rounded-2xl">
                <div className='p-5'>
            ...
            <div className="text-white relative overflow-hidden bg-linear-to-br from-indigo-500 to-violet-900 h-150 p-5 mx-8 lg:mx-15 md:mx-15 my-10 rounded-2xl">
                <div className='absolute top-1/2 -translate-y-1/2 -translate-x-2 md:left-1/2 md:-translate-x-1/2 lg:left-1/2 lg:-translate-x-1/2 space-y-10'>
