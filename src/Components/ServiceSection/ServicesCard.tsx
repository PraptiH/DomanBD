...
function ServicesCard({ service, index }: ServiceCardprops) {
    const positionClasses = [
        "lg:scale-125 lg:rotate-y-45",
        "lg:scale-120 lg:rotate-y-40",
        "lg:scale-115 lg:rotate-y-35",
        "lg:scale-110 lg:rotate-y-30",
        "lg:scale-105 lg:rotate-y-25",
    ];

    return (
        <div className={`${index !== 0 ? "ml-0 sm:ml-1" : ""} w-auto `}>
            <div
                className={`relative w-full max-w-[18rem] max-h-64 shadow-2xl rounded-xl bg-white px-5 py-6
