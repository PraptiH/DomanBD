function WebsiteMegaMenu() {
    return (
        <>
            <div className="flex items-start gap-50 border px-20">
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">DOMAINBD WEBSITE BUILDER</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <p className="text-2xl font-medium">Website Builder</p>
                                <p className="text-xl">Create free site with built-in marketing tools.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div>
                                <p className="text-2xl font-medium">Airo AI Builder</p>
                                <p className="text-xl">Your conversational business companion that build customized sites and web apps in minutes.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <p className="text-2xl font-medium">Online Store</p>
                                <p className="text-xl">Sell products, services and let customers book appointments in online.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">AI BUILDER</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                ...
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">HIRE AN EXPERT</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <div>
                                <p className="text-2xl font-medium">Website Design Services</p>
                                <p className="text-xl">Let our experts design and build your custom site</p>
                            </div>
                        </div>
