        ...
        <>
            <div className="flex items-start gap-50 border px-20">
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">HOSTING</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <p className="text-2xl font-medium">Web hosting</p>
                                <p className="text-xl">Enjoy fast, reliable, secure hosting.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div>
                                <p className="text-2xl font-medium">Hosting for WordPress</p>
                                <p className="text-xl">Hassle-free, fully-managed WordPress.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div>
                                <p className="text-2xl font-medium">Virtual Private Server</p>
                                <p className="text-xl">Get full control with root access and dedicated resources.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">TOOLS FOR AGENCIES</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            <img className="bg-[#D8EFEF] px-3 py-2 w-15 h-12 rounded-lg object-contain" src={logoBlack} alt="" />
                            <div>
                                <p className="text-2xl font-medium">DomainBd Agency Partner Program</p>
                                <p className="text-xl">Help grow your agency with our trusted partner.</p>
                            </div>
                        </div>
