function DomainMegaMenu() {
    return (
        <>
            <div className="flex items-center gap-50 border px-20">
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">FIND A DOMAIN</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-2xl font-medium">Search for Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Transfer Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">GTLD Domain Extensions</p>
                        </div>
                    </div>
                ...
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">DOMAIN INVESTING</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Auctions for Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Appraise Domain Name Value</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Discount Domain Search</p>
                        </div>
                    </div>
                ...
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">DOMAIN TOOLS AND SERVICES</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Find a Domain Owner (WHOIS)</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Generate Domain Names</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24"
                            ...
                            <p className="text-2xl font-medium">Bulk Domain Search</p>
                        </div>
                    </div>
