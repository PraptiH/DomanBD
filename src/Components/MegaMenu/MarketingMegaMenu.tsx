        ...
        <>
            <div className="flex items-start gap-50 border px-20">
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">MARKETING TOOLS</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-2xl font-medium">Logo Maker</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24" 
                            ...
                            <p className="text-2xl font-medium">Unified Inbox</p>
                        </div>
                    </div>
                ...
                <div className="mx-8 my-5">
                    ...
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <p className="text-2xl font-medium">Airo</p>
                                <p className="text-xl">Launce your brand quickly with a domain, logo, and social media marketing.</p>
                            </div>
                        </div>
