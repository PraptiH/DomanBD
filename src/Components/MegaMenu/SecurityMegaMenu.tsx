        ...
        <>
            <div className="flex items-start gap-50 border px-20">
                <div className="mx-8 my-5">
                    <h5 className="text-lg font-medium ">WEB SECURITY</h5>
                    <div className="flex flex-col gap-10 mt-5">
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <p className="text-2xl font-medium">SSL Certificates</p>
                                <p className="text-xl">Show visitors your siteis encrypted and trustworthy.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div>
                                <p className="text-2xl font-medium">Website Security</p>
                                <p className="text-xl">Comprehensive protection to help defend your site from threats.</p>
                            </div>
                        </div>
                    </div>
