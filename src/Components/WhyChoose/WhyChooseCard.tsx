...
function WhyChooseCard({provide}:ChooseCardProps) {
    return (
        <>
        <div className="bg-linear-to-r from-emerald-50 to-white w-70 h-70 lg:w-80 lg:h-80 md:w-80 md:h-80 rounded-2xl shadow-2xl text-center p-8 flex flex-col justify-center gap-3">
